...
public class FileSystemStorageService implements StorageService {
	...
	public Resource loadAsResource(String filename) {
		try{
			...
			throw new StorageFileNotFoundException("Fayl yadda oxunula  bilmedi"+filename);
			}
			}catch(MalformedURLException e){
			throw new StorageFileNotFoundException("Fayl yadda oxunula  bilmedi"+filename,e);
			}
	}
	@Override
